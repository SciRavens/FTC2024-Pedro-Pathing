...
public class ExampleAuto extends OpMode {
    ...
    private PathChain BackUpFromDroppingFirstSample, GoToPickUpSecondSample, Rotate, grabPickup1, grabPickup2, grabPickup3, scorePickup1, scorePickup2, scorePickup3;

    /** Build the paths for the auto (adds, for example, constant/linear headings while doing paths)
     * It is necessary to do this so that all the paths are built before the auto starts. **/
    private final Pose deliverfirstsamplePose = new Pose(15, 130, Math.toRadians(155)); // this works
    private final Pose backUpFromDroppingFirstSamplePose = new Pose(25, 130, Math.toRadians(0)); // this works
...
//        park.setLinearHeadingInterpolation(scorePose.getHeading(), parkPose.getHeading());
    ...
    public PathChain BackUpFromDroppingFirstSample() { // this works do NOT CHANGE
    ...
    public void autonomousPathUpdate() { // this works
        switch (pathState) {
            case 0:
                follower.followPath(BackUpFromDroppingFirstSample, true);
                setPathState(-1);
                break;
            case 1:
                if (!follower.isBusy()) {
...
//    }
    ...
    public void init() {
        ...
        follower.setStartingPose(deliverfirstsamplePose);
        setPathState(2);
